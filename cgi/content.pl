...
<iframe id="myIframe" src="http://localhost:8080/hello-world" frameborder="0"></iframe>

<script src="http://static.openfoodfacts.localhost/js/dist/iframe-resizer.parent.js"></script>
<script>
